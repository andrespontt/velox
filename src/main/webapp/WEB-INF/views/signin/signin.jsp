...
<form class="form-narrow form-horizontal" action='<s:url value="/j_spring_security_check"/>' method="post">
    <c:if test="${not empty param['error']}">
        <div class="alert alert-error">
            Email o Password incorrecto, favor ingresar nuevamente.
        </div>
    </c:if>
    <fieldset>
        <legend>Favor, Ingrese</legend>
        ...
        <div class="form-group">
            <div class="col-lg-offset-2 col-lg-10">
                <div class="checkbox">
                    <label>
                        <input type="checkbox" name="_spring_security_remember_me"> Recordarme
                    </label>
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="col-lg-offset-2 col-lg-10">
                <p>Usuario nuevo? <a href='<s:url value="/signup"/>'>Registrarse</a></p>
            </div>
        </div>
    </fieldset>
</form>
